...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(move |app| {
            ...
            #[cfg(debug_assertions)]
            {
                ...
                let command_names = [
                    ...
                    "production_decoder_status",
                    "production_set_decoder_path",
                    "production_clear_decoder_path",
                    "production_matchlab_proxy_cache_dir",
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::production_matchlab_proxy_cache_dir,
